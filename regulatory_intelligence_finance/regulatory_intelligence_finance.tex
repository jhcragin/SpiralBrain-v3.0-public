...
\begin{titlepage}
  \vspace*{\fill}
  \begin{center}
    \Huge\bfseries Regulatory Intelligence Under Economic Stress: \\[0.5em]
    \Large Tax Reasoning Stability in \\[0.2em]
    \Large Adversarial Environments \\[2em]
...
This work builds on the Regulatory Intelligence (RI) paradigm \cite{Cragin2026Thesis}, demonstrating its practical utility in domains where viability matters more than optimization. Building on prior work evaluating cognitive integrity under pressure \cite{Cragin2026Integrity}, this paper extends RI validation to adversarial financial domains.
