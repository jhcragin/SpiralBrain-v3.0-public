...
The label "**CCS**" (Cognitive/Computational Coherence Score) appears in both SpiralCortex v1.0 and v2.0, but **measures fundamentally different phenomena**. This semantic shift caused:
