...
This paper specifies the formal structure and governance semantics of Synthetic-Emotional Calibration (SEC) only. Empirical evaluations, geometric analyses, and domain-specific demonstrations are intentionally presented in separate companion works within the broader Regulatory Intelligence research corpus. The present paper should be read as a control-interface specification rather than a validation or application study.

Relevant companion works include:

\medskip
\noindent\textbf{\href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/Phase\%20Lock\%20Optimization\%20in\%20Regulatory\%20Cognitive\%20Architectures}{Phase Lock Optimization in Regulatory Cognitive Architectures}} \\
Formal analysis of phase-lock dynamics and stability bounds within viability-first cognitive systems.
 
\medskip
\noindent\textbf{\href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/bifurcation_integrity_collapse}{Bifurcation Points and Integrity Collapse in an Instrumented Cognitive System}} \\
Empirical study of attractor collapse, recovery, and stability preservation under regulatory stress.

\medskip
\noindent\textbf{\href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/Emotion\%20as\%20a\%20Control\%20Signal\%20for\%20Symbolic\%20Stability}{Emotion as a Control Signal for Symbolic Stability}} \\
Experimental validation of SEC-conditioned posture separation under identical inputs, demonstrating causal regulatory effects without learning.

\medskip
\noindent\textbf{\href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/RegulatoryAsymmetriesUnderScarcity}{Regulatory Asymmetries Under Scarcity}} \\
Analysis of adaptive versus coercive regulatory responses under matched scarcity regimes.

\medskip
\noindent\textbf{\href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/regulatory_intelligence_program}{The Regulatory Intelligence Paradigm: Geometric Homeostasis and Elastic Cognition}} \\
Research monograph defining the theoretical framework in which SEC operates as a physiological control interface for viability-first cognition. \\
Zenodo: \href{https://doi.org/10.5281/zenodo.18370539}{https://doi.org/10.5281/zenodo.18370539}

\medskip
Together, these works situate SEC within a coherent research program while preserving a strict separation between formal definition, system-level dynamics, and empirical validation.


\section{Relation to the Regulatory Intelligence Paradigm}

SEC serves as the physiological control interface of the Regulatory Intelligence (RI) paradigm, which defines viability-first cognition through geometric homeostasis and elastic regulation \cite{Cragin2026RI}. Within this framework, SEC provides a governed, inspectable control surface that enables bounded modulation of internal dynamics without persistent learning or external optimization. SEC does not define intelligence itself; rather, it enables regulated intelligence by constraining system behavior to remain within viability-preserving bounds under uncertainty.
...
The experiments reported in this study require execution within the full SpiralBrain v3.0 system. At present, this system is maintained as a unified research platform and is not publicly distributed.

To support transparency and independent evaluation, architectural documentation, configuration summaries, experiment specifications, and representative output artifacts corresponding to the reported results are publicly available at:
https://github.com/jhcragin/SpiralBrain-v3.0-public

These materials fully describe the experimental setup, coupling mechanisms, and evaluation metrics used in this work, but do not constitute an independently executable implementation.
