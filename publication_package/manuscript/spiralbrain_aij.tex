...
While the core SpiralBrain v3.0 engine is proprietary, this work provides **confirmable research standards** through comprehensive public artifacts. The repository at \url{https://github.com/jhcragin/SpiralBrain-v3.0-public} contains the full suite of raw experimental data, validation wrappers, analytical scripts, and JSON-encoded state transitions. This ensures findings are audit-ready and statistical derivations are fully transparent, adhering to the journal's standards for empirical integrity.
