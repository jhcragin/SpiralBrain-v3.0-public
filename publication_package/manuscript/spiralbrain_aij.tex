...
\textbf{Discovery:} Emotional inputs drive cognitive processes upstream, with reproducible coherence (0.431) and stability (SEC stability ~0.80) across independent runs. Emotions regulate pathway activation and sequencing, enabling adaptive behavior.
