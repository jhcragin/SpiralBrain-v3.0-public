...
def analyze_learning_patterns(result_file=None, generate_plots=False):
    ...
    print(f"   Response Trend: {second_avg - first_avg:+.3f}")
    print()
    ...
    print("✅ CONCLUSION: Multiple sequences reveal emotional dynamics that prove")
    print("   emotions are ACTIVE exploratory coordinates, not passive features!")
    print("   The brain uses emotion to navigate internal states, not decide survival.")
...
if __name__ == "__main__":
    ...
    analyze_learning_patterns(result_file=args.file, generate_plots=args.plots)