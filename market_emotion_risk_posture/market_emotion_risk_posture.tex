...
%{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255}
...
No claims of trading alpha, profitability, or universality are made. All quantitative statements in this paper are grounded in the recorded artifacts for run \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255}{market_emotion_research_20260120_201255}. Any non-quantitative interpretation is stated as a hypothesis with explicit falsification criteria.
...
For \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255}{market_emotion_research_20260120_201255}, the dataset spans 60 matched UTC days, from \texttt{2025-11-22} through \texttt{2026-01-20}, inclusive. The integrator matches sources by a UTC day key formatted as \texttt{YYYY-MM-DD}.
...
For \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255}{market_emotion_research_20260120_201255}, the recorded provenance hashes are:\footnote{Fear \& Greed payload SHA-256: \texttt{19a11878e84203466013594cf49eb5584a1f69e8702e5383fc3d9053e3759e0d}; BTC market payload SHA-256: \texttt{fc7db290bff8c070e92c40fad1ff8ee08e2a259dbd726749749a342bc63a86b7}; \texttt{market\_data\_used.json} SHA-256: \texttt{8785bb45407cfa07b843ae61379a0b92d759b30181d2305c04f669d691e3efb2}}
...
The public repository contains a frozen verification contract (\href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/VERIFICATION.md}{VERIFICATION.md}), a stdlib-only offline verifier (\href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/verify_reference_run.py}{verify_reference_run.py}), and a canonized reference specimen under \texttt{fixtures/market_emotion/reference_run/}. Verification requires no network access and does not execute SpiralBrain inference.
...
The following six profiles are tested in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255}{market_emotion_research_20260120_201255}:
...
When exposed to the same aligned 60-day market time series, the system exhibits a clean separation in participation behavior: hazard-biased profiles consistently refuse new exposure (\emph{hold}), while neutral and exploratory profiles consistently accept exposure (\emph{buy}). This separation is observed in run \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255}{market_emotion_research_20260120_201255}. This observation supports hypothesis H1 for this run. The emotional state is modulating the threshold for action rather than the certainty of the underlying belief.
...
This paper makes the following claims. Each claim is either directly verifiable from artifacts in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255}{market_emotion_research_20260120_201255} or is explicitly falsifiable.

\subsection{Artifact-Verifiable Claims}

\begin{itemize}
	\item \textbf{C1 (Run identity)}: The analyzed run \\ \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255}{market_emotion_research_20260120_201255}. \\
	\emph{Verification:} read \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/summary_report.json}{summary_report.json}.
	...
	\emph{Verification:} read \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/summary_report.json}{summary_report.json} for the \texttt{dataset\_provenance.alignment.matched\_days}, \texttt{matched\_day\_range}, and the explicit list \texttt{matched\_days\_in\_order}.
	...
	\emph{Verification:} recompute SHA-256 over the decompressed UTF-8 text of \\ \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/provenance/raw/19a11878e84203466013594cf49eb5584a1f69e8702e5383fc3d9053e3759e0d.json.gz}{19a11878e84203466013594cf49eb5584a1f69e8702e5383fc3d9053e3759e0d.json.gz} and \\ \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/provenance/raw/fc7db290bff8c070e92c40fad1ff8ee08e2a259dbd726749749a342bc63a86b7.json.gz}{fc7db290bff8c070e92c40fad1ff8ee08e2a259dbd726749749a342bc63a86b7.json.gz} and compare to \texttt{sources.*.sha256}.\footnote{Offline verification (no network, no inference) is provided by \texttt{verify\_reference\_run.py} for the canonized fixture specimen.}
...
\pagebreak
	...
	\emph{Verification:} hash the canonical JSON encoding of \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/provenance/market_data_used.json}{market_data_used.json} and compare to the recorded SHA-256.\footnote{Offline verification (no network, no inference) is provided by \texttt{verify\_reference\_run.py} for the canonized fixture specimen.}
    ...
    and \texttt{results\_summary.<profile>.error\_predictions} in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/summary_report.json}{summary_report.json}.
	...
	\emph{Verification:} read \texttt{results\_summary.<profile>.direction\_distribution} in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/summary_report.json}{summary_report.json} or the generated table included in this document.
	...
	\emph{Verification:} read \\ \texttt{dataset\_provenance.sources.fear\_greed.status\_code}, \\ \texttt{dataset\_provenance.sources.btc\_market.status\_code}, and the recorded \texttt{url} fields under \texttt{dataset\_provenance.sources} in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/summary_report.json}{summary_report.json}.
\end{itemize}
...
\begin{itemize}
  \item \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/summary_report.json}{summary_report.json}
  \item \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/provenance/market_data_used.json}{market_data_used.json}
  \item \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/provenance/raw/19a11878e84203466013594cf49eb5584a1f69e8702e5383fc3d9053e3759e0d.json.gz}{19a11878e84203466013594cf49eb5584a1f69e8702e5383fc3d9053e3759e0d.json.gz}
  \item \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/provenance/raw/fc7db290bff8c070e92c40fad1ff8ee08e2a259dbd726749749a342bc63a86b7.json.gz}{fc7db290bff8c070e92c40fad1ff8ee08e2a259dbd726749749a342bc63a86b7.json.gz}
  \item \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture/results/market_emotion_research_20260120_201255/VERIFY.sha256}{VERIFY.sha256}
\end{itemize}
...
\begin{quote}
\href{https://github.com/jhcragin/SpiralBrain-v3.0-public/market_emotion_risk_posture}{SpiralBrain-v3.0-public/market_emotion_risk_posture}
\end{quote}
