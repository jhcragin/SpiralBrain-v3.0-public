...
...onal profile'' as a controlled internal condition that changes the system's regulatory weighting of risk signals, without changing the external input stream. An emotional profile is instantiated by an injected \texttt{emotional\_state} parameter vector that modulates regulatory weighting. Let $x_t$ denote the aligned market input at day $t$ (fear/greed, price, volume). Let $\theta$ denote an emotional profile setting. The system emits a discrete posture $y_t \in \{\text{buy}, \text{hold}\}$ and a confidence value $c_t \in [0,1]$. The confidence value $c_t$ is treated here as a system-internal certainty signal, not a calibrated probability of market correctness.
...
For \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results}{market_emotion_participation_only_20260201}, the dataset spans 60 matched UTC days, from \texttt{2025-12-04} through \texttt{2026-02-01}, inclusive. The integrator matches sources by a UTC day key formatted as \texttt{YYYY-MM-DD}.
...
\begin{axis}[
    ...
    xticklabels={2025-12-04,2025-12-14,2025-12-24,2026-01-03,2026-01-13,2026-01-23,2026-02-01},
...
\end{axis}
\end{tikzpicture}
\caption{BTC Price (USD) and Fear \& Greed Index timeline for the experimental window (Dec 4, 2025 – Feb 1, 2026). Dashed lines indicate Fear/Neutral (25) and Greed (75) thresholds.}
\end{figure}

This visualization provides context for the experimental window (Dec 4, 2025 – Feb 1, 2026) by jointly displaying Bitcoin price (USD) and the Fear \& Greed Index. The period corresponds to post-correction consolidation, with sentiment transitioning from Extreme Fear toward Fear/Neutral dominance.
...
For \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results}{market_emotion_participation_only_20260201}, the recorded provenance hashes are directly verifiable from the linked files.
...
The following six profiles are tested in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results}{market_emotion_participation_only_20260201}:
...
The confirmatory run produced 1,200 predictions (20 profiles × 60 days) with identical market inputs. Results showed the same clean bifurcation: 16 profiles produced 100\% buy outcomes, while 4 profiles produced 100\% hold outcomes. This confirms that the buy/hold separation is not an artifact of the specific research profiles but a robust property of the regulatory mechanism.
...
control\_neutral        & 60 & 0.611 & 60 & 0 \\
defensive               & 60 & 0.547 & 0  & 60 \\
high\_hazard\_alert     & 60 & 0.559 & 0  & 60 \\
overconfident\_explorer & 60 & 0.543 & 60 & 0 \\
high\_uncertainty       & 60 & 0.587 & 60 & 0 \\
\hline
\end{tabular}
...
\begin{itemize}
	...
	\item \textbf{Buy/Hold}: counts of discrete posture outputs across the 60 days.
...
The exclusive use of buy and hold postures reflects participation control thresholds rather than bullish bias, consistent with governance-oriented participation control.
...
The binary posture space of \{buy, hold\} reflects the selected market regime and participation control thresholds; this run focuses exclusively on participation gating without considering exit strategies.
...
(\emph{buy}, \emph{hold}) under identical aligned market inputs.
...
This paper makes the following claims. Each claim is either directly verifiable from artifacts in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results}{market_emotion_participation_only_20260201} or is explicitly falsifiable.

\subsection{Artifact-Verifiable Claims}

\begin{itemize}
	\item \textbf{C1 (Run identity)}: The analyzed run \\ \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/tree/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results}{market_emotion_participation_only_20260201}. \\
	\emph{Verification:} read \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/participation_summary.json}{participation_summary.json}.

	\item \textbf{C2 (Dataset size and alignment)}: The run uses 60 matched days in UTC with start \texttt{2025-12-04} and end \texttt{2026-02-01}. \\
	\emph{Verification:} read \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/participation_summary.json}{participation_summary.json} for the \texttt{dataset\_provenance.alignment.matched\_days}, \texttt{matched\_day\_range}, and the explicit list \texttt{matched\_days\_in\_order}.
	...
	\emph{Verification:} recompute SHA-256 over the decompressed UTF-8 text of \\ \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/provenance/raw/13dfc36313284bfed8b96ff07d79261f0e623e1f697db4d1abb8f370136f8309.json.gz}{13dfc36313284bfed8b96ff07d79261f0e623e1f697db4d1abb8f370136f8309.json.gz} and \\ \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/provenance/raw/68c0dec43aa301dac8e541f2c20dcc223677ea40f44eeb4d69c93e8bf623ac46.json.gz}{68c0dec43aa301dac8e541f2c20dcc223677ea40f44eeb4d69c93e8bf623ac46.json.gz} and compare to \texttt{sources.*.sha256}.
    ...
    and \texttt{results\_summary.<profile>.error\_predictions} in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/participation_summary.json}{participation_summary.json}.

	\item \textbf{C6 (Observed posture distributions)}: In this run, \texttt{high\_hazard\_alert} and \texttt{defensive} selected hold on every aligned day in the 60-day window; the other four profiles selected buy on every aligned day in the same window. \\
	\emph{Verification:} read \texttt{results\_summary.<profile>.direction\_distribution} in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/participation_summary.json}{participation_summary.json} or the generated table included in this document.
	...
	\emph{Verification:} read \\ \texttt{dataset\_provenance.sources.fear\_greed.status\_code}, \\ \texttt{dataset\_provenance.sources.btc\_market.status\_code}, and the recorded \texttt{url} fields under \texttt{dataset\_provenance.sources} in \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/participation_summary.json}{participation_summary.json}.
\end{itemize}
...
\begin{itemize}
  \item \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/participation_summary.json}{participation_summary.json}
  ...
  \item \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/provenance/raw/13dfc36313284bfed8b96ff07d79261f0e623e1f697db4d1abb8f370136f8309.json.gz}{13dfc36313284bfed8b96ff07d79261f0e623e1f697db4d1abb8f370136f8309.json.gz}
  \item \href{https://github.com/jhcragin/SpiralBrain-v3.0-public/blob/main/Emotion-Conditioned%20Risk%20Posture%20in%20Crypto%20Markets/results/provenance/raw/68c0dec43aa301dac8e541f2c20dcc223677ea40f44eeb4d69c93e8bf623ac46.json.gz}{68c0dec43aa301dac8e541f2c20dcc223677ea40f44eeb4d69c93e8bf623ac46.json.gz}
...
\begin{itemize}
	...
	\item The binary posture space may reflect the dataset's lack of sustained downtrends; future experiments could explore different market regimes.
	\item De-risking thresholds constitute a distinct experimental question and are left to future work.
\end{itemize}
...
\subsection{Reference Run Generation (Documented for Completeness)}

This paper is grounded in a single, fixed reference run whose outputs, hashes, and provenance artifacts are publicly archived and sufficient for independent verification. Re-execution of the system is neither required nor expected for falsification of the reported claims.

For methodological completeness, we note that reference runs are generated using the full SpiralBrain system by querying upstream market data providers and executing deterministic inference over an aligned time window. These execution steps require system components that are not included in the public repository and are therefore documented only at a descriptive level.

Verification of the results presented in this paper is performed exclusively via offline inspection of the archived artifacts, using the provided hashes and standard-library verifier, without executing SpiralBrain or re-querying external data sources.

\appendix

\section{Reference Examples (Artifact Formats)}

This appendix presents small verbatim excerpts from the published artifacts and the offline verifier to illustrate the concrete file formats used in this study. The examples show the structure of the JSON result files, the hashing routines, and the canonicalization rules applied during verification.

A complete SHA-256 manifest covering all referenced artifacts is included in the public verification package:
\begin{quote}
...
Together, these materials allow readers to inspect file structure and verify artifact integrity without executing inference code or accessing external data sources.

\subsection{Run Summary (participation\_summary.json)}

The run summary is a single JSON file that binds together provenance, alignment metadata, and per-profile aggregate outcomes for the canonical reference experiment. All quantitative results reported in the paper are derived directly from this file.

Verbatim excerpt from:\\
\texttt{fixtures/market\_emotion/reference\_run/participation\_summary.json}
(\emph{excerpted for length})
...
\begin{Verbatim}[fontsize=\small,breaklines=true,breakanywhere=true]
{
  ...
  "results_summary": {
    "control_neutral": {
      ...
      "error_predictions": 0,
      "error_rate": 0.0,
      "avg_confidence": 0.6106100968706908,
      "direction_distribution": {
        "buy": 60,
        "hold": 0,
        "error": 0
      },
      "avg_ccn_coherence": null,
      "avg_reflection_count": 8.0
    },
    "high_hazard_alert": {
      "total_predictions": 60,
      "valid_predictions": 60,
      "error_predictions": 0,
      "error_rate": 0.0,
      "avg_confidence": 0.5586020232886562,
      "direction_distribution": {
        "buy": 0,
        "hold": 60,
        "error": 0
...
\medskip
\noindent
The run summary functions as the primary index for the reference experiment. Verification does not require re-execution of inference or access to external data sources; integrity is established by computing cryptographic hashes over the run summary and all referenced artifacts using a fixed canonicalization scheme.

\subsection{Verifier Snippet (Offline Checks)}

Verbatim excerpt from \texttt{verify\_reference\_run.py} illustrating the canonical hashing rules applied during offline verification:
