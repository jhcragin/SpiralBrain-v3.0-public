...
\textbf{Learning confined to experimental process}: Knowledge accumulation occurs at the methodological level—researchers learn from observing system behavior, refining experimental protocols, and improving measurement techniques.\footnote{A precise operational definition of ``learning'' as used in SpiralBrain, including explicit exclusions and boundaries, is provided in the accompanying documentation (SPIRALBRAIN\_LEARNING\_MODEL.md).}
