...
\midrule
$\coupling^*$ & $\approx 0.25$ & $0.115$ & Empirical attractor equilibrium & Diverges from theoretical optima \\
\midrule
$\coh'$ (coupling vs. power) & Integration $\gg$ Magnitude & — & Correlation $r > 0.8$ & Prioritizes integration over computational power \\
\midrule
...
\midrule
SEC\_drift threshold & $< 0.15$ & $< 0.20$ & Stable & Enables stable emotional regulation \\
\midrule
Recovery time & $< 300$ steps & --- & Observed & Supports rapid cognitive recovery \\
\midrule
\phaselock & $74^\circ \pm 5^\circ$ & --- & Stable coupling & Optimizes differentiation and coherence \\
\midrule
